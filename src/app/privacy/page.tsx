      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white/80 backdrop-blur-xl rounded-[36px] shadow-2xl p-8 lg:p-12 border border-white/50">
          ...
          <div className="space-y-8 text-gray-700 font-cute">
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">1. 基本方針</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">2. 収集する情報</h2>
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-text-muted mb-2">2.1 アップロード画像</h3>
                  <p className="leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-text-muted mb-2">2.2 使用ログ</h3>
                  <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">3. 情報の利用目的</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">4. 第三者への提供</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">5. データの保存期間</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">6. Cookieの使用</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">7. セキュリティ対策</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">8. AI生成画像に関する注意事項</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">9. プライバシーポリシーの変更</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-text mb-4">10. お問い合わせ</h2>
              <p className="leading-relaxed">
            ...
            <div className="mt-12 pt-8 border-t border-border text-center">
              ...
              <div className="bg-gradient-to-r from-surface to-orange-50 rounded-2xl p-6 mt-8">
                <h3 className="text-xl font-bold text-text mb-4">🚀 今すぐAI画像変換を体験</h3>
                <p className="text-text-muted mb-6">プライバシーを保護しながら、美しいアニメ画像を生成できます</p>
