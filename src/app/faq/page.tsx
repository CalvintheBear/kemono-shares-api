...
export const metadata = {
  ...
  description: "2kawaii.comのAI画像生成サービスFAQ。無料で写真をアニメ風に変換・商用利用可能・登録不要・2-5分高速生成・プライバシー保護など、よくある質問に詳しく回答。",
  openGraph: {
...
const faqData: FAQItem[] = [
  ...
  },
  {
    category: "利用方法",
    question: "どのように使いますか？",
    answer: "1. シンプルモードで好きなスタイルテンプレートを選ぶか、マニュアルモードでカスタムプロンプトを入力します。2. 変換したい画像をアップロードします。3. 画像サイズを選択します。4. 「変身させる」ボタンを押して、2-5分で完了です！"
  },
  {
    category: "利用方法",
  ...
  },
  {
    ...
    answer: "最新のGPT-4o Vision AI技術を使用して、画像の特徴を分析し、選択されたスタイルに基づいて新しいアニメ画像を生成します。このプロセスは完全に自動で、ユーザーは2-5分で高品質な結果を得ることができます。"
  },
  {
    category: "技術的な質問",
  ...
  },
  {
    ...
    answer: "通常2-5分で完了しますが、サーバー混雑時は5分程度かかる場合があります。5分以上経過しても完了しない場合は、ページを更新してもう一度お試しください。"
  },
  {
    category: "著作権",
