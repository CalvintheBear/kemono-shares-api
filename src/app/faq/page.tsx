...
export const metadata = {
  ...
  description: "2kawaii.comのAI画像生成サービスFAQ。無料で写真をアニメ風に変換・商用利用可能・登録不要・数秒高速生成・プライバシー保護など、よくある質問に詳しく回答。",
  openGraph: {
...
const faqData: FAQItem[] = [
  ...
  },
  {
    category: "利用方法",
    question: "どのように使いますか？",
    answer: "1. シンプルモードで好きなスタイルテンプレートを選ぶか、マニュアルモードでカスタムプロンプトを入力します。2. 変換したい画像をアップロードします。3. 画像サイズを選択します。4. 「変身させる」ボタンを押して、数秒で完了です！"
  },
  {
    category: "利用方法",
  ...
  },
  {
    ...
    answer: "GPT-4o Image および Flux Kontext を使用して、画像の特徴を分析し、選択されたスタイルに基づいて新しいアニメ画像を生成します。このプロセスは完全に自動で、ユーザーは数秒で高品質な結果を得ることができます。"
  },
  {
    category: "技術的な質問",
  ...
  },
  {
    ...
    answer: "通常は数秒で完了しますが、混雑時はやや時間がかかる場合があります。1分以内に完了しない場合は、ページを更新して再試行してください。"
  },
  {
    category: "著作権",
