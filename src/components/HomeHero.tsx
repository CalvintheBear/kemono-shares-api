    ...
    <section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 animate-fade-in">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-text mb-6 lg:mb-8">
          <span className="block">{isEnglish ? 'Nanobanana AI Image Conversion' : 'Nanobanana AI画像変換 完全無料'}</span>
          <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2">{isEnglish ? 'In seconds with Nanobanana AI' : 'Nanobanana AI で数秒仕上げ'}</span>
        </h1>
